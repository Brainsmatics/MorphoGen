...
if __name__ == '__main__':
    ...
    smooth_set = np.load(r'.\denosie\branches\pci_15000_true16.npy')
    assert len(noise_set) == len(smooth_set),"error"
    ...
    for epoch in range(epoches):
        ...
        for data in tqdm(train_loader):
            ...
            # noise_branch = normalize(noise_branch)
            # smooth_branch = normalize(smooth_branch)
            ...
            # loss = recon_loss(out_put, smooth_branch)
        ...
        np.save(r'./denosie/loss_npy/train16.npy', loss1)
        np.save(r'./denosie/loss_npy/test16.npy', loss2)
